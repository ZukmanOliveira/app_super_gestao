    ...
    <div class="informação-pagina">
        ...
        <div style="width: 30%; margin-left: auto; margin-right: auto;"> 
            ...
            <form action="{{route( 'produto.update',[ 'produto' => $produto->id ])}}" method="post">
                ...
                <input type="text" name="descrição"  value="{{$produto->descricao ?? old('descricao')}}" placeholder="Descrição"  class="borda-preta">
                ...
                <select name="unidade_id" >
                    ...
                    @foreach ($unidades as $unidade)
                        <option value="{{$unidade->id}} {{$produto->unidade_id ?? old('unidade_id') == $unidade->id ? 'selected' : ''}} {{$unidade->descricao}}">Unidade</option>
                    @endforeach
                </select>
